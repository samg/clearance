...
Define a host and and do not reply address in config/clearance.yml

In the production environment it must be the actual host your application is deployed to.
